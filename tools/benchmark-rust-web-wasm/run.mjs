...
const EXPECTED_ABI = optionValues('abi').length === 0 ? 'rust-web-planner-abi-v2' : requiredOption('abi')
const EXPECTED_POLICY = optionValues('policy').length === 0
  ? 'generic-craft-external-reference-v2.4.0'
  : requiredOption('policy')
