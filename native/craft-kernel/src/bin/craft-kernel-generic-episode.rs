...
use frozen_rabbit_craft_kernel::research::{
    ...
    ARTISAN_EXPERT_REFERENCE_POLICY_VERSION, CACHED_PORTFOLIO_POLICY_VERSION,
    CERTIFIED_PORTFOLIO_POLICY_VERSION, CERTIFIED_ROUTE_EXPERIMENT_VERSION,
    COMPACT_PORTFOLIO_POLICY_VERSION, COMPLETION_AWARE_PORTFOLIO_EXPERIMENT_VERSION,
    COMPLETION_AWARE_PORTFOLIO_POLICY_VERSION, CONDITION_OPPORTUNITY_ABLATION_EXPERIMENT_VERSION,
    ...
    EXPERIMENTAL_PORTFOLIO_POLICY_VERSION, EXTERNAL_REFERENCE_CERTIFIED_FINISH_EXPERIMENT_VERSION,
    ...
    FULL_QUALITY_CERTIFICATE_DEPTH7_EXPERIMENT_VERSION, GENERIC_BUDGETED_CONDITION_POLICY_VERSION,
    ...
    RESOURCE_CERTIFICATE_EXPERIMENT_VERSION, RESOURCE_PORTFOLIO_POLICY_VERSION,
            ...
            ]
        {
            println!(
                ...
                [
                    ...
                    ARTISAN_EXPERT_REFERENCE_POLICY_VERSION,
                    EXTERNAL_REFERENCE_CERTIFIED_FINISH_EXPERIMENT_VERSION,
                    EXTERNAL_REFERENCE_FULL_QUALITY_CERTIFICATE_EXPERIMENT_VERSION,
                    GENERIC_EXTERNAL_REFERENCE_V2_POLICY_VERSION,
                    GENERIC_EXTERNAL_REFERENCE_V21_POLICY_VERSION,
                    frozen_rabbit_craft_kernel::research::GENERIC_EXTERNAL_REFERENCE_V22_POLICY_VERSION,
                    ...
                    ARTISAN_CONTINUATION_EXPERIMENT_VERSION,
                    frozen_rabbit_craft_kernel::research::OPENING_RECOVERY_EXPERIMENT_VERSION,
                    frozen_rabbit_craft_kernel::research::EAGER_RECOVERY_EXPERIMENT_VERSION,
                    frozen_rabbit_craft_kernel::research::COMPACT_RECOVERY_EXPERIMENT_VERSION,
                    frozen_rabbit_craft_kernel::research::SHORT_CERTIFIED_FINISH_EXPERIMENT_VERSION,
                    frozen_rabbit_craft_kernel::research::TIME_BUDGETED_RECOVERY_POLICY_VERSION,
                    frozen_rabbit_craft_kernel::research::GENERIC_EXTERNAL_REFERENCE_V24_POLICY_VERSION,
