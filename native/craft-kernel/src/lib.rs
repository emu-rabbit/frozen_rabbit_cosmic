...
mod research_exports {
    ...
    pub use crate::generic_episode::{
        ...
        execute_generic_episode_with_portfolio_budget, execute_generic_episode_with_time_budget,
    ...
    pub use crate::generic_solver::{
        ...
        QualityUtilityKind, RESOURCE_CERTIFICATE_EXPERIMENT_VERSION,
        RESOURCE_PORTFOLIO_POLICY_VERSION, ROUTE_PORTFOLIO_CONTEXT_VERSION,
