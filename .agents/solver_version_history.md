...
| `generic-craft-external-reference-v2.1.0` | 證明深度提高為四步，其餘 fallback／逐步重證邊界不變；目前採用。使用者接受相對 v1.12 的品質／完成交換，不是全面支配。 | [採納判讀](../reports/generic-cosmic-overnight/v210-adoption-review-20260907.md) |
