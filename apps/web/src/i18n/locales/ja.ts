...
export default {
  ...
  faq: {
    ...
    algorithmAnswer: "現在のv2.3ソルバーはArtisan's Expert Solverを基に、実験とテストで計算時間と成果のバランスを検証した複数の戦略を追加しています。詳しいアルゴリズムの説明は{guide}をご覧ください。",
    algorithmLink: "こちら",
  ...
  algorithm: {
    ...
    "priority": "製作を完成させながら、残りの耐久とCPをできるだけ高い品質につなげます。",
    "foundation": {
    ...
    "opening": {
      "title": "v2.3ではマニピュレーションを早めに検討",
      "first": "マニピュレーションは後続のアクションで耐久を回復できますが、先にCPを使います。v2.3では真価の後に、今使う場合と、そのまま作業を進めたり素材状態を待ったりする場合を比較するため、以前より早く提案されることがあります。",
