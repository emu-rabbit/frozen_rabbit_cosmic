...
export default {
  ...
  algorithm: {
    ...
    "time": {
      ...
      "first": "制限時間のある任務では、最初の素材状態の報告からバックグラウンドで残り時間を見積もります。手動での調整は不要です。各品目を1個ずつ製作すると仮定し、予備の時間を差し引いて、未完成の品目に残り時間を均等に割り当てます。操作を取り消したり品目を切り替えたりしても、カウントダウンは引き継がれます。",
