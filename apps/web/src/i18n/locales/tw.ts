...
export default {
  ...
  faq: {
    ...
    algorithmAnswer: "目前的 v2.3 求解器以 Artisan's Expert Solver 為基礎，加入了多項依據實驗和測試證明在求解速度下和收益取捨有成效的策略。詳細演算法介紹可參考{guide}。",
    algorithmLink: "這裡",
  ...
  algorithm: {
    ...
    "priority": "在完成製作的同時，讓剩餘的耐久與 CP 盡可能換成更好的品質。",
    "foundation": {
    ...
    "opening": {
      "title": "v2.3 的新安排：提早使用掌握",
      "first": "掌握能在後續操作中逐步恢復耐久，但需要先花費 CP。v2.3 在使用閒靜後，會比較現在啟用掌握，是否比繼續製作或等球更有幫助，因此你可能會比以前更早看到掌握的建議。",
