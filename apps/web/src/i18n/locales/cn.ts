...
export default {
  ...
  faq: {
    ...
    algorithmAnswer: "目前的 v2.3 求解器以 Artisan's Expert Solver 为基础，加入了多项经实验和测试验证、在求解速度与收益之间取得有效取舍的策略。详细算法介绍可参考{guide}。",
    algorithmLink: "这里",
  ...
  algorithm: {
    ...
    "priority": "在完成制作的同时，让剩余的耐久与 CP 尽可能换成更好的品质。",
    "foundation": {
    ...
    "opening": {
      "title": "v2.3 的新安排：提前使用掌握",
      "first": "掌握能在后续操作中逐步恢复耐久，但需要先花费 CP。v2.3 在使用闲静后，会比较现在启用掌握，是否比继续制作或等球更有帮助，因此你可能会比以前更早看到掌握的建议。",
